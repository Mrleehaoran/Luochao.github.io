...
<head>
    <title>罗超式音游</title>
    <meta itemprop="name" content="罗超式音游" />
    <meta itemprop="description" content="罗超式音游" />
    <meta charset="utf-8" />
    ...
    <script src="https://cdn.staticfile.org/tw  itter-bootstrap/5.1.1/js/bootstrap.bundle.min.js"></script>
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">罗超式音游</div><br />
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="罗超的诱惑">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
